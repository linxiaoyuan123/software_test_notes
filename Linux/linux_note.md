...
![vim命令模式](D:\学习\study_everyday\assets\linux_note\vim命令模式.jpg)

![vim命令模式1](D:\学习\study_everyday\assets\linux_note\vim命令模式1.jpg)

![vim命令模式2](D:\学习\study_everyday\assets\linux_note\vim命令模式2.jpg)
...
![底线命令模式](D:\学习\study_everyday\assets\linux_note\底线命令模式.jpg)
...
![配置sudo认证](D:\学习\study_everyday\assets\linux_note\配置sudo认证.jpg)
...
![用户组管理命令](D:\学习\study_everyday\assets\linux_note\用户组管理命令.jpg)

#### 3）用户管理命令：

![用户管理命令](D:\学习\study_everyday\assets\linux_note\用户管理命令.jpg)

![用户管理命令1](D:\学习\study_everyday\assets\linux_note\用户管理命令1.jpg)
...
![系统用户](D:\学习\study_everyday\assets\linux_note\系统用户.jpg)
...
![系统用户组](D:\学习\study_everyday\assets\linux_note\系统用户组.jpg)
...
![权限信息](D:\学习\study_everyday\assets\linux_note\权限信息.jpg)

#### 2）权限细节解读

![权限细节解读](D:\学习\study_everyday\assets\linux_note\权限细节解读.jpg)
